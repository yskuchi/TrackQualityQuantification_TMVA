...
void TrackQualityQuantificationApplication( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start TrackQualityQuantificationApplication" << std::endl;
   ...
   std::cout << "--- TrackQualityQuantificationApp    : Using input file: " << input->GetName() << std::endl;
   ...
   std::cout << "==> TrackQualityQuantificationApplication is done!" << std::endl << std::endl;
}
...
int main( int argc, char** argv )
{
   ...
   TrackQualityQuantificationApplication(methodList);
   return 0;
}
